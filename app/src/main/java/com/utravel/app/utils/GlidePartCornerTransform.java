...
/**
 * Created by mChenys on 2018/5/11. Glide 部分倒角
 */
public class GlidePartCornerTransform implements Transformation<Bitmap> {
	...
	public GlidePartCornerTransform(Context context, float radius) {
