...
public class ToastUtil {
    ...
    public static void showShortToast(String msg) {
        if(Latte.getApplicationContext() != null){
            if (toast == null) {
                toast = Toast.makeText(Latte.getApplicationContext(), msg, Toast.LENGTH_SHORT);
            } else {
                toast.setText(msg);
            }
            toast.show();
    ...
    public static void showLongToast(String msg) {
        if(Latte.getApplicationContext() != null) {
            if (toast == null) {
                toast = Toast.makeText(Latte.getApplicationContext(), msg, Toast.LENGTH_LONG);
            } else {
                toast.setText(msg);
            }
            toast.show();
