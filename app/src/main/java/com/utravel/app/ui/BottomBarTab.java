...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon, CharSequence title) {
        ...
        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.text_color_black));
        ...
        mTvTitle.setTextColor(ContextCompat.getColor(context, R.color.text_color_black));
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            if (mTabPosition==0) {
                mIcon.setImageResource(R.mipmap.shouye_on);
            }else if (mTabPosition==1) {
                mIcon.setImageResource(R.mipmap.shequ_on);
            }else if (mTabPosition==2) {
                mIcon.setImageResource(R.mipmap.wode_on);
            }
//            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.delegate_red));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.delegate_red));
        } else {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.text_color_black));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.text_color_black));
        }
    }
