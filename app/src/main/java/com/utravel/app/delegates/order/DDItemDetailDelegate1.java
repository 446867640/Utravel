...
public class DDItemDetailDelegate1 extends LatterDelegate implements View.OnClickListener {
    ...
    public static DDItemDetailDelegate1 newInstance(String id) {
        DDItemDetailDelegate1 fragment = new DDItemDetailDelegate1();
