...
public class JDOrderDelegate extends LatterDelegate implements View.OnClickListener {
...
//                                helder.setText(R.id.tv_rewarded_balance, "预估返" + bean.getRewarded_balance());
    ...
    private void getOrderData() {
        String url = Config.PRODUCT_JD_ORDER; //接口URL
        String apiName = "京东订单列表接口"; //接口名
                    ...
                    public void onFail(Call arg0, Exception arg1, int arg2) {
                        ...
                        if (arg1.getMessage()!=null) {
                            if (arg1.getMessage().contains("401")) {
                                ...
                                ((MyOrderDelegate)getParentFragment()).getSupportDelegate().startWithPop(new LoginChoiceDelegate());
                            }
                        }
                    }
                });
