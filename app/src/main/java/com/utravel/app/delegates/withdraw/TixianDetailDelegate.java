...
public class TixianDetailDelegate extends LatterSwipeBackDelegate implements View.OnClickListener {
    ...
    public static TixianDetailDelegate newInstance(String type) {
        TixianDetailDelegate fragment = new TixianDetailDelegate();
