...
public class SortRightDelegate1 extends LatterDelegate {
    ...
    public static SortRightDelegate1 newInstance(int position) {
        SortRightDelegate1 fragment = new SortRightDelegate1();
    ...
    private void processSortRightData(String json) {
        ...
        if (dataBean!=null && dataBean.size()>0){
            ...
            final List<MultipleItemEntity> datas = new SortRightDataConverter1(mCurrentPosition).setJsonData(json).convert();
            ...
            adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
                ...
                public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                    ((MainDelegate)getParentFragment().getParentFragment()).getSupportDelegate().start(
