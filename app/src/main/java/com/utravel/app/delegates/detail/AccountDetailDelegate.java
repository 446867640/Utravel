...
public class AccountDetailDelegate extends LatterSwipeBackDelegate implements View.OnClickListener {
    ...
    public static AccountDetailDelegate newInstance(String value) {
        AccountDetailDelegate fragment = new AccountDetailDelegate();
    ...
    private void initViews(View rootView) {
        ...
        gv_account = (MyGridView) rootView.findViewById(R.id.gv_account);
