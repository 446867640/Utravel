...
public class LoginChoiceDelegate1 extends LatterDelegate implements View.OnClickListener {
    AppCompatImageView iv_back, iv_bg, iv_login_zhuce, iv_login_phone, iv_login_weixin;
    ...
    public void onClick(View v) {
        if (v==iv_back) {//返回
            ...
            getSupportDelegate().startWithPop(new ZhuCeDelegate1());
        }else if (v==iv_login_phone) {//手机登陆
            getSupportDelegate().startWithPop(new LoginPhoneDelegate1());
