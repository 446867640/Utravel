...
public class LoginPhoneDelegate1 extends LatterDelegate implements View.OnClickListener, ITimerListener, View.OnKeyListener {
    View status_bar;
    ...
    public void onClick(View v) {
        ...
        }else if ( v==tv_zhuce ) { //用户注册
            getSupportDelegate().start(new ZhuCeDelegate1());
...
//            getSupportDelegate().start(ChangeLoginMMDelegate.newInstance("forget"));
        }else if (v==tv_xieyi) { //用户协议
            getSupportDelegate().start(new UserXieYiDelegate());
